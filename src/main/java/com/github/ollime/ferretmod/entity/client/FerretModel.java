...
//    }
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData upper_body = ferret.addChild("upper_body", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -1.2153F, 4.0613F));

        ModelPartData headneck = upper_body.addChild("headneck", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 2.2153F, -6.0613F));

        ModelPartData head = headneck.addChild("head", ModelPartBuilder.create().uv(32, 28).cuboid(-1.5F, -0.1875F, -3.1875F, 3.0F, 2.0F, 2.0F, new Dilation(0.0F))
                .uv(16, 32).cuboid(1.0F, -1.6875F, 0.5625F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
                .uv(16, 32).cuboid(-2.0F, -1.6875F, 0.5625F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
                .uv(24, 8).cuboid(-2.5F, -0.9375F, -1.9375F, 5.0F, 3.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -4.8125F, -3.0625F));
        ...
        ModelPartData right_front_leg = upper_body.addChild("right_front_leg", ModelPartBuilder.create().uv(8, 26).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.15F, 0.2153F, -5.3113F));

        ModelPartData left_front_leg = upper_body.addChild("left_front_leg", ModelPartBuilder.create().uv(0, 26).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(1.15F, 0.2153F, -5.3113F));

        ModelPartData body_1 = upper_body.addChild("body_1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.774F, -7.0606F));
        ...
        ModelPartData lower_body = ferret.addChild("lower_body", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -1.2153F, 4.0613F));

        ModelPartData body_2 = lower_body.addChild("body_2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData right_back_leg = lower_body.addChild("right_back_leg", ModelPartBuilder.create().uv(24, 28).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.2F, 2.2153F, 4.9387F));

        ModelPartData left_back_leg = lower_body.addChild("left_back_leg", ModelPartBuilder.create().uv(16, 26).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(1.2F, 2.2153F, 4.9387F));

        ModelPartData tail_group = lower_body.addChild("tail_group", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 1.2153F, 6.9387F));
...
//        if (entity.isSitting()) {
//            this.animateMovement(FerretAnimations.SITTING, limbSwing, limbSwingAmount, 2f, 2.5f);
//            this.updateAnimation(entity.IdleAnimationState, FerretAnimations.SITTING, ageInTicks, 1f);
//        }
    }
